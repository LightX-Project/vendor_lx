...
ALARM_PATH := vendor/lx/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/lx/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/lx/prebuilt/common/media/audio/ringtones
